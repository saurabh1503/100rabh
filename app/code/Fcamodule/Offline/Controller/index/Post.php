...
namespace Fcamodule\Offline\Controller\Index;
...
/**
	...
	//if(trim($answers ['success']) == true) {
		...
		$Format = $objectManager->create('Fcamodule\Offline\Model\Submitquote');
		$products = $objectManager->create('Fcamodule\Offline\Model\Quoteproduct');
