...
class Edit extends \TNA\Profile\Controller\Adminhtml\Curriculum
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('tna_profile_curriculum', $model);
        
        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Curriculum') : __('New Curriculum'),
            $id ? __('Edit Curriculum') : __('New Curriculum')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Archives'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Curriculum'));
        return $resultPage;
    }
}
