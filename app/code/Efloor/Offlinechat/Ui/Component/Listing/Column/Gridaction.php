<?php
namespace Efloor\Offlinechat\Ui\Component\Listing\Column;
...
{
    /** Url path */
   const REVIEW_URL_PATH_EDIT = 'offlinechat/grid/edit';
   const REVIEW_URL_PATH_DELETE = 'offlinechat/grid/delete';
   const REVIEW_URL_PATH_VIEW = 'offlinechat/view/index';
