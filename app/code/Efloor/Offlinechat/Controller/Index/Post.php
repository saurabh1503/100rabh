...
namespace Efloor\Offlinechat\Controller\Index;
...
/**
    ...
    public function execute() {
		...
		$secret = "6Lf79xwUAAAAAA2LyYyCXORmEvm7CXvqh1HGTxK3"; //Replace with your secret key
		$response = null;
	...
	//if(trim($answers ['success']) == true) {
		...
		$Format = $objectManager->create('Efloor\Offlinechat\Model\Submitquote');
		$products = $objectManager->create('Efloor\Offlinechat\Model\Quoteproduct');
