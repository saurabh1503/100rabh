...
namespace Boolfly\ProductRelation\Block\Adminhtml\Catalog\Product\Edit\Tab;

use Magento\Backend\Block\Widget\Grid\Column;
use Magento\Backend\Block\Widget\Grid\Extended;
use Magento\Catalog\Model\Product;

class Sizetype extends Extended
{
    /**
     * Core registry
     *
    ...
    {
        parent::_construct();
        $this->setId('sizetype_product_grid');
    ...
    {
        $products = $this->getProductsSizetype();
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedSizetypeProducts());
        }
        return $products;
    }
     ...
     * @return array
     */
    public function getSelectedSizetypeProducts()
    {
        $products = [];
        foreach ($this->_coreRegistry->registry('current_product')->getSizetypeProducts() as $product) {
