...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [
            ['link_type_id' => \Boolfly\ProductRelation\Model\Catalog\Product\Link::LINK_TYPE_CUSTOMTYPE, 'code' => 'customoptions'],
			['link_type_id' => \Boolfly\ProductRelation\Model\Catalog\Product\Link::LINK_TYPE_SIZETYPE, 'code' => 'shapeoptions']
        ];
        ...
        $data = [
            ...
            [
                'link_type_id' => \Boolfly\ProductRelation\Model\Catalog\Product\Link::LINK_TYPE_SIZETYPE,
                'product_link_attribute_code' => 'position',
                'data_type' => 'int',
            ]
        ];
