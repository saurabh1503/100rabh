...
class Rule extends \Magento\SalesRule\Model\Rule
{
    ...
    public function getCouponTypes()
    {
        if ($this->_couponTypes === null) {
            $this->_couponTypes = [
                \Magento\SalesRule\Model\Rule::COUPON_TYPE_NO_COUPON => __('Automatically apply in cart'),
                \Magento\SalesRule\Model\Rule::COUPON_TYPE_SPECIFIC => __('Customer must enter the coupon'),
            ];
