...
$rowNew['Detailed Description'] = $product->getMetaDescription();
$rowNew['Categorization'] = GetCategoryID($product->getData('pproducttypeid'),$rowNew['Product Title']);
$rowNew['Product URL'] = $product->getProductUrl();
$rowNew['Primary Image URL'] = $imgurl.$product->getImage();
$rowNew['Selling Price'] = $price;
